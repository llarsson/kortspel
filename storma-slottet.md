...
När det är en spelares tur kan denne göra en av tre drag:
 ...
 - Hela: spelaren kan välja att hela sitt skadade Aktiva kort med valfritt antal kort från en och samma färg (vanliga sifferkort och Lönnmördare av rätt färg samt Jokrar kan kombineras fritt). De måste vara av samma färg som det egna Aktiva kortet (exempelvis kan hjärter Dam bara helas av hjärter-kort, Läkare undantagna). Helande kort spelas ut styckvis, ett efter ett (dock kan alltså flera spelas ut under en och samma spelares tur). När ett kort används för helande kan det plocka bort Skadekort vars summa är mindre än eller lika med helande kortets poängvärde. Antag att ett kort har Skadekort 2, 4 och 7. En helande 6:a kan då ta bort 2 och 4, men ej 7. Ytterligare helande krävs för att få bort sista skadan. De helande korten och de Skadekort de tagit bort går direkt till Kasthögen. Kvar skall alltså bara aktuella Skadekort vara på det Aktiva kortet.
   - Vanliga kort av samma färg som det egna Aktiva kortet kan hela maximalt så mycket som dess poängvärde. 
   - Jokrar kan hela, men endast om Aktiva kortet har 10 eller mindre Skadepoäng kvar. Kasta 2T10 och välj den högre av tärningarnas värde. Om Jokern fumlar (båda visar 0), dör det Aktiva kortet och går till den spelare som utförde den senaste framgångsrika attacken (alltså, gjorde senaste skadan) som Trofé.
   - Läkare helar 7 + 2T10 (så maximalt 25 totalt). Fumlar Läkaren dock med dubbla nollor, skadas det Aktiva kortet så att det endast har 1 Skadepoäng kvar.
